...
class AdapterAdminChatUser(private val messages: List<Any>?) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun getItemViewType(position: Int): Int {
        ...
        return when {
            message is Message -> {
                if (message.sender == "admin") TYPE_ADMIN else TYPE_USER
            }
    ...
    class ReminderViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(message: MessageReminder) {
            if(message.statusReminder == "needApproved"){
                ...
                val main = itemView.findViewById<LinearLayout>(R.id.disetujui)
