...
import com.example.projekconsultant.adapter.AdminDataPendaftaranUser
import com.example.projekconsultant.myfragment.RiwayatTidakAdaJadwalDisetujui
import com.example.projekconsultant.myfragment.RiwayatTidakAdaJadwalPersetujuan
import com.google.android.material.bottomnavigation.BottomNavigationView



class RiwayatPovAdminOffline : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            dataPendaftaranOnline = it.getParcelableArrayList("DATAPENDAFTARAN")
    ...
    companion object {
        @JvmStatic
        fun newInstance(param1: String) = RiwayatPovAdminOffline().apply {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater.inflate(R.layout.fragment_riwayat_pov_admin_offline, container, false)
        ...
        sharedDatas.dataPendaftaran.observe(requireActivity()) { updatedData ->
            var butuhPersetujuanAdmin:ArrayList<DataPendaftaran> = ArrayList()
            var diSetujuiAdmin:ArrayList<DataPendaftaran> = ArrayList()

            updatedData.filter { it.onoff == "Offline" }.forEach { data ->
            ...
            val menuItems = listOf(
                AdapterAdminLayananRiwayatItem("Butuh Persetujuan", if (butuhPersetujuanAdmin.isNotEmpty()) OfflineRiwayatButuhPersetujuanPovAdmin.dataButuhPersetujuan(butuhPersetujuanAdmin)
                else RiwayatTidakAdaJadwalDisetujui()),
                AdapterAdminLayananRiwayatItem("Di Setujui", if (diSetujuiAdmin.isNotEmpty()) OfflineRiwayatDisetujuiPovAdmin.dataDiSetujui(diSetujuiAdmin)
                else RiwayatTidakAdaJadwalDisetujui()),
            )
        ...
        //        if(sharedDatas.dataPendaftaran.value?.find { it.onoff == "offline" } == null){
...
//private val offline:String = "Offline"
...
//        "Z-22","Zara","" +
//                "22 Desember","Via Chat WA (Online)",
//        "Keluarga","Jadi Gini Curhat Keluarga",
//        true,false, online),
//    DataPendaftaran(
//        "W-23","Wakus",
//        "21 Desember","Via Video Call (Online)",
//        "Finansial","Saya Kenapa ya, kadang rasanya capek banget sama semua? Tugas kuliah numpuk, teman-teman suka berubah-ubah, dan orang tua juga ",
//        true,false, online),
//)


//val dat = arrayListOf(
//    AdminDataPendaftaranUser("Offline","Agiyas", "Curhat Remaja"),
//    AdminDataPendaftaranUser("Offline","Raple", "Keluarga"),
//)