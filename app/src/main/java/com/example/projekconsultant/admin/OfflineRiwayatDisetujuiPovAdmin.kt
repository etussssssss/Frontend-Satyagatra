...
import com.example.projekconsultant.adapter2.AdapterAdminDiSetujuiOffline


class OfflineRiwayatDisetujuiPovAdmin : Fragment() {
    ...
    companion object {
        @JvmStatic
        fun newInstance(param1: String, param2: String) = OfflineRiwayatDisetujuiPovAdmin().apply {
        ...
        fun dataDiSetujui(datas: ArrayList<DataPendaftaran>) = OfflineRiwayatDisetujuiPovAdmin().apply {
            arguments = Bundle().apply {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater.inflate(R.layout.fragment_offline_riwayat_disetujui_pov_admin, container, false)
        ...
        val adapter = AdapterAdminDiSetujuiOffline(thData)
        rec.adapter = adapter
