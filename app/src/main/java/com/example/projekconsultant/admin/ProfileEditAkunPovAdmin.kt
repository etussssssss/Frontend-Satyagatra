...
class ProfileEditAkunPovAdmin : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_profile_edit_akun_pov_admin)
    ...
    private fun saveProfile(mname: String, mgender: String, mdomisili: String, mnomortelepon: String, mtanggallahir: String, mstatus: String) {
        ...
        db.collection("datas").document(userId).update(updates).addOnSuccessListener {
            ...
            val intent = Intent(this@ProfileEditAkunPovAdmin, MainAdminActivity::class.java)
...
//            val cek1 = "${etName.text}".equals("${cekName}")
//            val cek2 = "${etDomisili.text}".equals("${cekDomisili}")
//            val cek3 = "${etNomor.text}".equals("${cekNomor}")



//                Log.d("HASIL", "${cekName}, ${cekGender}, ${cekDomisili}, ${cekNomor}, ${cekTanggalLahir},${cekStatusHubungan}")
