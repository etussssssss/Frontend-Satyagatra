...
class AdapterAdminRiwayatItem (private val items: List<AdapterAdminLayananRiwayatItem>, private val listener: (AdapterAdminLayananRiwayatItem) -> Unit) :
    RecyclerView.Adapter<AdapterAdminRiwayatItem.MenuViewHolder>() {
